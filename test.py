...
from model import createStartingGLNASModel, addLayerToGLNASModel, createModelManually, BestModelTrainer, createResNetFromGLNASManually, createManually
...
CONST_SAVED_MODEL_PARENT_DIR = "cifar10_tf_e20_202303091600_0"
...
def main():
    ...
    GLNASModel = createResNetFromGLNASManually((224, 224, 3), 1000)
    # GLNASModel = createManually((224, 224, 3), 1000)
